                        ...
                        return (
                            <div key={data.id + "bannerHome" + index} className='min-w-full min-h-[450px] overflow-hidden lg:min-h-full relative group transition-all ' style={{ transform: `translateX(-${currentImage * 100}%)` }}>
                                ...
                                <div className='container mx-auto'>
                                    <div className=' w-full absolute bottom-0 max-w-md px-4 pb-5'>
                                        ...
                                        <button className='bg-white px-4 py-2 text-black font-bold rounded-md mt-4 hover:bg-gradient-to-l from-red-700 to-orange-500 transition-all hover:scale-105 shadow-md hover:text-white'>
                                            Play Now
                                        </button>
                                    </div>
                                </div>
